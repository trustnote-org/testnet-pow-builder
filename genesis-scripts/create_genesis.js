...
var allAddress = [];
var arrOutputs = [
    {address: "A3TEKUPJMRKNKJBO2NOKLGKONMFWLR7P", amount: 0 } //第一笔，找零地址。
];
...
function createPayment(from_address){
    ...
    var from_address = "A3TEKUPJMRKNKJBO2NOKLGKONMFWLR7P";
    var payee_address = "DE6I5BJFJCXZXPJEP73TESEZFERGY7LH";
    var arrOutputs = [
